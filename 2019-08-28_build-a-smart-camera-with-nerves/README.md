...
2019! I really hope you enjoy the class, learn some new things, and come away
...
* Hardware
  * Raspberry Pi Zero W
  * Vilroz Zero case with 3 covers
  * Raspberry Pi Camera V2
  * Raspberry Pi Camera Lens Adjustment Tool
  * 16 GB Class 10 MicroSD Card
  * MicroSD Card reader and standard-size SD adapter
* Cables
  * USB-A to MicroUSB
  * 4-port USB-A hub with MicroUSB
  * HDMI to Mini HDMI
...
* Erlang and Elixir
  ...
  For this class, we will be using Erlang 22 and Elixir 1.9.1. To get those
  installed using ASDF, do the following:

  ```bash
  asdf plugin-add erlang https://github.com/asdf-vm/asdf-erlang.git
  asdf plugin-add elixir https://github.com/asdf-vm/asdf-elixir.git
  asdf install erlang 22.0.7 # This takes a while
  ...
  Install the `nerves_bootstrap` archive (you should get `v1.6.2` or newer):
